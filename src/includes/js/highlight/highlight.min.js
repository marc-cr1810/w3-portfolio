...
;hljs.registerLanguage("dos",e)})();/*! `glsl` grammar compiled for Highlight.js 11.7.0 */
...
className:"subst",begin:"@[0-9]+"}]})})();hljs.registerLanguage("avrasm",r)})();/*! `go` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>{const n={
